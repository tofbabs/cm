...
class Utils{
    ...
    **/ 
    ...
    /*
	**	Encode and Decode Email for Security
    */

    static function encode_email($email){
    	$enc_email = str_rot13($email);
    	return str_replace('@', 'cmp' , $enc_email);
    }

    static function decode_email($encoded){
    	$email = str_replace('cmp', '@' , $encoded);
    	return str_rot13($email);
    }


    /*
	**	Connects to PHPResque to Fetch status of campaign queue
    */
    static function getCampaignStatus($campaign_id){
    	return 50;
    }
